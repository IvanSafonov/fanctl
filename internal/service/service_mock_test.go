...
//
//	mockgen -package service -destination ./service_mock_test.go . FanDriver,ProfileDriver,SensorDriver
//
...
// DefaultLevel mocks base method.
func (m *MockFanDriver) DefaultLevel() string {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DefaultLevel")
	ret0, _ := ret[0].(string)
	return ret0
}

// DefaultLevel indicates an expected call of DefaultLevel.
func (mr *MockFanDriverMockRecorder) DefaultLevel() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DefaultLevel", reflect.TypeOf((*MockFanDriver)(nil).DefaultLevel))
}
